...
const expression = e => program(`make x:1; print ${e};`).statements[1].argument
...
const tests = [
  ...
  ["removes x=x", program("make x:1; x:x; print(x);"), core.program([letXEq1, print(x)])],
  [
    "optimizes while test",
    program("whileLoop sqrt(25) {}"),
