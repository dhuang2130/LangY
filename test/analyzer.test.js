...
const semanticChecks = [
  ["variables can be printed", "make x : 1; print x;"],
  ["variables can be reassigned", "make x : 1; x : x * 5 / ((-3) + x);"],
...
const semanticErrors = [
  ...
  ["re-declared identifier", "make x : 1; make x : 2;", /Identifier x already declared/],
...
const sample = "make x:sqrt(9);function f(x):3*x;whileLoop(true){x:3;print(0?f(x):2);}"
